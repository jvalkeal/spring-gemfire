...
/**
 * 
 * DefaultResultCollector gathers result from all the function execution
 * nodes.<br>
 ...
 */
public class DefaultResultCollector implements ResultCollector<Serializable, Serializable> {
